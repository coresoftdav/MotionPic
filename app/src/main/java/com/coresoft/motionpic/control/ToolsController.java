package com.coresoft.motionpic.control;
...
import com.coresoft.motionpic.activity.MotionEditActivity;
import com.coresoft.motionlibs.adapter.EffectAdapter;
import com.coresoft.motionlibs.adapter.StickerAdapter;
import com.coresoft.motionlibs.callback.OnClickListner;
import com.coresoft.motionlibs.callback.OnStickerClickListner;
import com.coresoft.motionlibs.customView.beans.Ponto;
import com.coresoft.motionpic.coustom.TrianguloBitmap;
...
public class ToolsController implements OnClickListener {
    ...
    public void setSelecionando(Ponto ponto, final Ponto ponto2) {
        ...
        AnimacaoController.getInstance().iterarPontos(new AnimacaoController.IteradorDePonto() {
            @Override

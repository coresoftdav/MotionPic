...
import com.coresoft.motionpic.BuildConfig;
import com.coresoft.motionpic.R;
import com.coresoft.motionpic.coustom.MyAlbumActivity;
...
public class MainActivity extends HomeParentActivity implements OnClickListener {
...
//					videoStatus.setText("Video status: Video playback has ended.");
    ...
    private void loadNative() {
        ...
        builder.forNativeAd(nativeAd -> {
            ...
            @SuppressLint("InflateParams") NativeAdView adView = (NativeAdView) LayoutInflater.from(this).inflate(R.layout.item_native_ad_unified, null);

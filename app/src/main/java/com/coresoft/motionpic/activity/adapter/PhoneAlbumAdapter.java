package com.coresoft.motionpic.activity.adapter;
...
import com.coresoft.motionlibs.model.PhoneAlbum;
import com.coresoft.motionlibs.model.PhonePhoto;
import com.coresoft.motionlibs.utils.Share;
import com.coresoft.motionpic.activity.AlbumListActivity;
        ...
        public ViewHolder(View view) {
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    intent.putExtra(Share.KEYNAME.ALBUM_NAME, ((PhoneAlbum) al_album.get(getAdapterPosition())).getName());
